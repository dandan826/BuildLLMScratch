...
### Listing 2.3 Implemmenting a simple text tokenizer
import re
class SimpleTokenizerV1:
  ...
  def encode(self, text):
    ...
    #### add get(s) to avoid unexpected key error
...
### Load Byte Pair Encoding -- used by gpt 2 and gpt3
...
def create_dataloader_v1(txt,
  ...
  # use stride equal to max_length can avoid overlap between batches
